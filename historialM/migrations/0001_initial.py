# Generated by Django 5.2.7 on 2025-11-24 02:08
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "mascota",
                    models.CharField(
                        max_length=100, verbose_name="Nombre de la Mascota"
                    ),
                ),
                (
                    "tipo_mascota",
                    models.CharField(max_length=50, verbose_name="Tipo de Mascota"),
                ),
                ...
                (
                    "proxima_cita",
                    models.DateField(
                        blank=True, null=True, verbose_name="Proxima cita recomendada"
                    ),
                ),
                ...
                (
                    "es_urgente",
                    models.BooleanField(default=False, verbose_name="Caso urgente"),
                ),
                (
                    "cita",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "nombre_vacuna",
                    models.CharField(
                        max_length=100, verbose_name="Nombre de la vacuna"
                    ),
                ),
                (
                    "fecha_aplicacion",
                ...
                (
                    "proxima_dosis",
                    models.DateField(
                        blank=True, null=True, verbose_name="Próxima dosis"
                    ),
                ),
                (
                    "lote",
                ...
                (
                    "veterinario_aplico",
                    models.CharField(
                        max_length=100, verbose_name="Veterinario que aplicó"
                    ),
                ),
                (
                    "historial",
